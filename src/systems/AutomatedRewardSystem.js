    ...
    grantReward(itemId, silent = false) {
        ...
        if (machineType) {
            ...
            if (machineType === 'DISPENSER') {
                ...
                // Also add the sauce to the menu slots so it appears on burger orders
                this.game.menuSystem.addToppingToMenu(configId);
            } else {
            ...
            this.game.menuSystem.addToppingToMenu(itemId);
        }
